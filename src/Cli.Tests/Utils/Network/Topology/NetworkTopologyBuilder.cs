...
internal sealed class NetworkTopologyBuilder {
  ...
  private NetworkTopology.SubnetDefinition? _coordinatorSubnet;
  ...
  /// <summary>
  /// Attach a subnet to the coordinator for local scanning.
  /// </summary>
  public NetworkTopologyBuilder WithCoordinatorSubnet( NetworkTopology.SubnetDefinition subnet ) {
    _coordinatorSubnet = subnet;
    return this;
  }
  ...
  public NetworkTopology Build() {
    ...
    return new NetworkTopology {
      Subnets = subnets,
      CoordinatorSubnet = _coordinatorSubnet,
      Agents = _agents,
