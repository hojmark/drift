...
public static class ServiceCollectionExtensions {
  ...
  public static void AddMessagingCore(
    ...
    // Dispatchers, correlators, and handlers are scoped to an active messaging
    // connection. The stream manager creates and owns that scope.
    services.AddScoped<MessageDispatcher>();
    services.AddScoped<MessageResponseCorrelator>();
    services.AddSingleton<IMessageStreamManager, MessageStreamManager>();
  }
}